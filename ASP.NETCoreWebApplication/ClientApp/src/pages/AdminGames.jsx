...
export const AdminGames = (props) => {
    ...
    const handleChange = e => {
        ...
        if (e.target.type === 'checkbox') {
            let checkboxValue;
            /*Checking for opposite string because of states being async*/
            value === 'false' ? checkboxValue = true : checkboxValue = false;
            setGame(prevState => ({...prevState, [name]: checkboxValue}));
        } else {
